...
public partial class UC_InternalMugshotPreview : UserControl
{
    ...
    // Internal (not private): UC_LiveTileViewport reuses the exact same spec so a
    // live tile's initial framing is pixel-identical to the autogenerated mugshot.
    internal static CameraFraming.MeshAware BuildAutoFramingSpec(InternalMugshotSettings cfg)
    {
